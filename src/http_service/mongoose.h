...
struct mg_connection *mg_sntp_connect(struct mg_mgr *mgr, const char *url, mg_event_handler_t fn,
                                      void *fn_data);
...
struct mg_connection *mg_mqtt_listen(struct mg_mgr *mgr, const char *url, mg_event_handler_t fn,
                                     void *fn_data);
...
struct mip_if
{
    ...
    struct queue1       queue;              // Set queue.len for interrupt based drivers
